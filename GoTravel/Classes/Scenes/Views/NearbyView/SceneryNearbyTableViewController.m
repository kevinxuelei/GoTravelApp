//
//  SceneryNearbyTableViewController.m
//  GoTravel
//
...
@interface SceneryNearbyTableViewController ()
...
@implementation SceneryNearbyTableViewController
...
-(void)loadValue
{
    ...
    [NetWorkHandle getDataWithURLString:[NSString stringWithFormat:@"http://api.breadtrip.com/place/pois/nearby/?category=11&start=%ld&count=20&latitude=%f&longitude=%f",_indexStart,_latitude,_longitude] compare:^(id object) {
...
#pragma mark ---创建数据库
        [KDataBasehandle createtableName:@"scenery" Modelclass:[NearbyTableViewModel class]];
...
-(void)loadRefresh
{
    ...
    __weak SceneryNearbyTableViewController *RVC = self;
