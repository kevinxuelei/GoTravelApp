...
@implementation RouteReferViewController
...
- (void)viewDidLoad {
    ...
    self.mapView = [[BMKMapView alloc]initWithFrame:CGRectMake(0, 180, self.view.frame.size.width, self.view.frame.size.height - 180)];
    ...
    //郑州二七广场  郑州火车站  北京欢乐谷  北京大学 郑州大学 郑州
...
#pragma mark ----根据overlay(覆盖物)生成对应的View
...
#pragma mark ----返回公交搜索结果 (searcher 搜索对象)
