//
//  RestaurantNearbyTableViewController.m
//  GoTravel
//
...
@interface RestaurantNearbyTableViewController ()
...
@implementation RestaurantNearbyTableViewController
...
-(void)loadValue
{
    ...
    [NetWorkHandle getDataWithURLString:[NSString stringWithFormat:@"http://api.breadtrip.com/place/pois/nearby/?category=5&start=%ld&count=20&latitude=%f&longitude=%f",_indexStart,_latitude,_longitude] compare:^(id object) {
        ...
        [KDataBasehandle createtableName:@"restaurant" Modelclass:[NearbyTableViewModel class]];
...
-(void)loadRefresh
{
    ...
    __weak RestaurantNearbyTableViewController *RVC = self;
