//
//  EntertainmentNearbyTableViewController.m
//  GoTravel
//
...
@interface EntertainmentNearbyTableViewController ()
...
@implementation EntertainmentNearbyTableViewController
...
-(void)loadValue
{
    ...
    [NetWorkHandle getDataWithURLString:[NSString stringWithFormat:@"http://api.breadtrip.com/place/pois/nearby/?category=21&start=%ld&count=20&latitude=%f&longitude=%f",_indexStart,_latitude,_longitude] compare:^(id object) {
        NSDictionary *dic = object;
        NSArray *array = dic[@"items"];
        
        
        [KDataBasehandle createtableName:@"entertainment" Modelclass:[NearbyTableViewModel class]];
...
#pragma mark ---下拉刷新上拉加载的位置
-(void)loadRefresh
{
    //上拉刷新
    
    __weak EntertainmentNearbyTableViewController *RVC = self;
