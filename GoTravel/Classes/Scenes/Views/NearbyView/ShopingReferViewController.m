...
@interface ShopingReferViewController ()<BMKMapViewDelegate,BMKPoiSearchDelegate,BMKLocationServiceDelegate>
...
- (IBAction)onClickNextPage:(id)sender;
...
@implementation ShopingReferViewController
