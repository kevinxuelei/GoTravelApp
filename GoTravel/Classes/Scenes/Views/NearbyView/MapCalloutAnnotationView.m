...
@interface MapCalloutAnnotationView()
...
+(instancetype)calloutViewWithMapView:(MKMapView *)mapView{
    ...
    MapCalloutAnnotationView *calloutView=(MapCalloutAnnotationView *)[mapView dequeueReusableAnnotationViewWithIdentifier:calloutKey];
    if (!calloutView) {
        calloutView=[[MapCalloutAnnotationView alloc]init];
    }
    return calloutView;
}

#pragma mark 当给大头针视图设置大头针模型时可以在此根据模型设置视图内容
-(void)setAnnotation:(MapCalloutAnnotion *)annotation{
