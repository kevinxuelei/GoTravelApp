...
@interface FoodReferViewController ()<BMKMapViewDelegate, BMKPoiSearchDelegate,BMKLocationServiceDelegate>
...
@implementation FoodReferViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    //设置地图的view(这里必须对地图的大小设置否则无法显示)
    self.mapView = [[BMKMapView alloc]initWithFrame:CGRectMake(0, 100, self.view.frame.size.width, self.view.frame.size.height - 100)];
