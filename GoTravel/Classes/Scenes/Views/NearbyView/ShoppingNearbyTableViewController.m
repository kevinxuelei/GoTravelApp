//
//  ShoppingNearbyTableViewController.m
//  GoTravel
//
...
@interface ShoppingNearbyTableViewController ()
...
@implementation ShoppingNearbyTableViewController
...
-(void)loadValue
{
    ...
    [NetWorkHandle getDataWithURLString:[NSString stringWithFormat:@"http://api.breadtrip.com/place/pois/nearby/?category=6&start=%ld&count=20&latitude=%f&longitude=%f",_indexStart,_latitude,_longitude] compare:^(id object) {
...
#pragma makr ---创建数据库
        [KDataBasehandle createtableName:@"shoping" Modelclass:[NearbyTableViewModel class]];
...
-(void)loadRefresh
{
    ...
    __weak ShoppingNearbyTableViewController *RVC = self;
